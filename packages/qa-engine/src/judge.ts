...
const RECOMMENDATION: Record<string, string> = {
  ...
  "NET-BLOCKED-ORB":
    "응답의 Content-Type을 요청한 리소스 종류에 맞추세요. 이미지 URL이면 image/png 처럼 정확한 타입을 내려야 합니다. " +
    "Cross-Origin-Resource-Policy 헤더를 함께 확인하세요.",
  "NET-BLOCKED-CLIENT":
    "브라우저 확장이나 사내 정책이 원인일 수 있습니다. 다른 환경에서도 재현되는지 먼저 확인하세요.",
  "NET-ABORTED":
    "의도한 취소인지 확인하세요. 화면 전환 시 진행 중인 요청을 정리하는 것은 정상이지만, " +
    "필요한 데이터까지 취소되고 있다면 요청 시점을 조정해야 합니다.",
  "NET-UNREACHABLE": "호스트 주소와 포트, 방화벽 규칙을 확인하세요.",
  "NET-TLS": "서버 인증서의 유효기간과 체인, 도메인 일치 여부를 확인하세요.",
...
const IMPACT: Record<string, string> = {
  ...
  "NET-BLOCKED-ORB": "브라우저가 응답을 버려서 해당 이미지나 리소스가 화면에 표시되지 않습니다.",
  "NET-BLOCKED-CLIENT": "일부 사용자 환경에서만 해당 요소가 보이지 않을 수 있습니다.",
  "NET-ABORTED": "취소된 요청이 필요한 데이터였다면 화면 일부가 비어 보입니다.",
  "NET-UNREACHABLE": "해당 서버에 의존하는 기능 전체를 쓸 수 없습니다.",
  "NET-TLS": "해당 서버와 통신할 수 없어 기능이 동작하지 않습니다.",
